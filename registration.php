...
<tr><td>Gmail:<td><input type="text" required="" name="gmail"placeholder="Email" value=""></td></tr>
...
if(isset($_POST["submit"]))
{
    ...
    $qry="insert into reg values('$name','$regno','$password','$confirm_password','$dept','$gender','$gmail','$contact')";
